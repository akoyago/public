...
function getAppConsentUri($tenantId) {
    "https://login.microsoftonline.com/$tenantId/oauth2/authorize?client_id=a86b9632-42bf-4dfe-83c8-bbc95145504b&response_type=code&redirect_uri=https://tools.onakoyago.com/AdminConsent&nonce=doesntmatter&resource=https://graph.microsoft.com&prompt=admin_consent"
}
